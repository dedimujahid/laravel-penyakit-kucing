    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('artikel.show', ['artikel' => $artikel->id]) }}" class="btn btn-info btn-sm">Detail</a>
                    <a href="{{ route('artikel.edit', ['artikel' => $artikel->id]) }}" class="btn btn-warning btn-sm">Edit</a>
                    <form action="{{ route('artikel.destroy', ['artikel' => $artikel->id]) }}" method="post" class="d-inline">
                        @csrf
                        @method('DELETE')
